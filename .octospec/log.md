...
Chronological index of completed octospec tasks. One dated line per Finish.

- 2026-06-25 — phase1-mvp-core — MVP passthrough gateway (PR #3). [journal](journal/shared/phase1-mvp-core.md)
- 2026-06-25 — phase2-moa-orchestration — MoA fan-out/quorum/concat-judge (PR #5). [journal](journal/shared/phase2-moa-orchestration.md)
...
- 2026-06-26 — v0.2.0-release — version bump 0.1.0→0.2.0 + RELEASE notes (release收口, no functional change). [journal](journal/shared/v0.2.0-release.md)
